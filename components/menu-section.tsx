    ...
    <section id="carta" className="relative overflow-hidden bg-[#f2ede7] pt-12 pb-14 md:pt-16 md:pb-24 lg:pt-24 lg:pb-28">
      ...
      <div className="relative mx-auto max-w-7xl px-6 lg:px-8 motion-safe:animate-in motion-safe:fade-in-0 motion-safe:slide-in-from-bottom-4 motion-safe:duration-700">
        <div className="text-center mb-10 md:mb-16">
          ...
          <div className="mt-4 inline-flex items-end justify-center gap-2.5 md:gap-4">
            <h2 className="font-serif text-4xl md:text-5xl lg:text-6xl font-medium text-foreground">
              La Carta
            </h2>
            <div className="relative -mb-1 h-[4.2rem] w-[4.2rem] shrink-0 opacity-88 md:h-[4.8rem] md:w-[4.8rem] lg:h-[5.4rem] lg:w-[5.4rem]">
              <Image
                src="/gilda-mark.png"
                alt="Gilda de Acorde"
                fill
